    ...
    <div className="relative min-h-[calc(100dvh-70px)] w-full flex flex-col items-center justify-center p-4 sm:p-6 overflow-hidden select-none">
      ...
      <div className="relative z-10 max-w-xl w-full text-center space-y-6 animate-phase-enter">
        ...
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass-card border border-purple-500/40 text-xs font-bold text-pink-300 shadow-glow animate-stagger-1">
          ...
          <span>✦ A SECRET BIRTHDAY MISSION AWAITS ✦</span>
        </div>
        ...
        >
          ...
          <div className="relative z-10 space-y-6">
            {/* DOB Badge */}
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-purple-950/70 border border-purple-400/30 text-xs font-semibold text-purple-200">
              <Star className="w-3.5 h-3.5 text-amber-300 fill-amber-300" />
              <span>{birthdayConfig.dobFormatted}</span>
            </div>

            {/* Name Reveal with 3D depth animation */}
            <div className="space-y-1">
              <p className="text-xs uppercase tracking-[0.3em] text-pink-400 font-bold animate-stagger-2">
                ✦ HAPPY BIRTHDAY ✦
              </p>
              <h1
            ...
            <button
              ...
              disabled={clicked}
              className="btn-3d group relative w-full py-4 sm:py-5 rounded-2xl bg-gradient-to-r from-purple-600 via-pink-600 to-amber-500 text-white font-black text-lg sm:text-xl shadow-2xl shadow-pink-900/60 hover:scale-[1.02] active:scale-95 transition-all duration-200 flex items-center justify-center gap-3 overflow-hidden disabled:opacity-80 disabled:cursor-wait animate-stagger-4"
            >
              {/* Shimmer sweep */}
              ...
              <span className="relative z-10">{clicked ? 'Loading Quest...' : '🎁 Start the Surprise Quest'}</span>
